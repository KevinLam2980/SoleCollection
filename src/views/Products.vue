                  ...
                  <tbody>
                      <tr v-for="product in products">
                        ...
                        <td>
                          ...
                          <button class="btn btn-primary btn-sm edit-btn" @click="editProduct(product)">Edit</button>
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="editLabel">{{modal == 'edit' ? 'Edit Product' : 'Create Product' }}</h5>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-4">
                    ...
                    <div class="form-group">
                      <input type="text" @keyup.32="addTag" placeholder="Product tags (space to add)" v-model="tag" class="form-control">
